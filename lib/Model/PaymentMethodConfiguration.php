...
class PaymentMethodConfiguration implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'data_collection_type' => '\Meeteeor\Sdk\Model\DataCollectionType',
        'description' => 'map[string,string]',
        'id' => 'int',
        'image_resource_path' => '\Meeteeor\Sdk\Model\ModelResourcePath',
        'linked_space_id' => 'int',
        'name' => 'string',
        'one_click_payment_mode' => '\Meeteeor\Sdk\Model\OneClickPaymentMode',
        'payment_method' => 'int',
        ...
        'sort_order' => 'int',
        'space_id' => 'int',
        'state' => '\Meeteeor\Sdk\Model\CreationEntityState',
     ...
     *
     * @return \Meeteeor\Sdk\Model\DataCollectionType
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\DataCollectionType $data_collection_type The data collection type determines who is collecting the payment information. This can be done either by the processor (offsite) or by our application (onsite).
     *
     * @return $this
     */
     ...
     *
     * @return \Meeteeor\Sdk\Model\ModelResourcePath
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\ModelResourcePath $image_resource_path The image of the payment method configuration overrides the default image of the payment method.
     *
     * @return $this
     */
     ...
     *
     * @return \Meeteeor\Sdk\Model\OneClickPaymentMode
     */
     ...
     * Gets state
     *
     * @return \Meeteeor\Sdk\Model\CreationEntityState
     */
     ...
     * Sets state
     *
     * @param \Meeteeor\Sdk\Model\CreationEntityState $state The object's current state.
     *
     * @return $this
     */
