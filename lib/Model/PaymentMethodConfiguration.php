...
class PaymentMethodConfiguration implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'int',
        'image_resource_path' => '\Planet\Sdk\Model\ModelResourcePath',
        'linked_space_id' => 'int',
        'name' => 'string',
        'one_click_payment_mode' => '\Planet\Sdk\Model\OneClickPaymentMode',
        'payment_method' => 'int',
     ...
     *
     * @param \Planet\Sdk\Model\DataCollectionType $data_collection_type The data collection type determines who is collecting the payment information. This can be done either by the processor (offsite) or by our application (onsite).
     *
     * @return $this
     */
     ...
     *
     * @return \Planet\Sdk\Model\ModelResourcePath
     */
     ...
     *
     * @param \Planet\Sdk\Model\ModelResourcePath $image_resource_path The image of the payment method configuration overrides the default image of the payment method.
     *
     * @return $this
     */
     ...
     *
     * @return \Planet\Sdk\Model\OneClickPaymentMode
     */
