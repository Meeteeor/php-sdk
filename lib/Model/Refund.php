...
class Refund implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'amount' => 'float',
        'base_line_items' => '\Meeteeor\Sdk\Model\LineItem[]',
        'completion' => 'int',
        'created_by' => 'int',
        'created_on' => '\DateTime',
        ...
        'reduced_line_items' => '\Meeteeor\Sdk\Model\LineItem[]',
        'reductions' => '\Meeteeor\Sdk\Model\LineItemReduction[]',
        'state' => '\Meeteeor\Sdk\Model\RefundState',
        'succeeded_on' => '\DateTime',
        'taxes' => '\Meeteeor\Sdk\Model\Tax[]',
        'time_zone' => 'string',
        'timeout_on' => '\DateTime',
        'total_applied_fees' => 'float',
        'total_settled_amount' => 'float',
        'transaction' => '\Meeteeor\Sdk\Model\Transaction',
        'type' => '\Meeteeor\Sdk\Model\RefundType',
        'updated_invoice' => 'int',
        'version' => 'int'
    ];
     ...
     *
     * @param \Meeteeor\Sdk\Model\LineItem[] $base_line_items 
     *
     * @return $this
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\LineItem[] $reduced_line_items 
     *
     * @return $this
     */
     ...
     * Gets reductions
     *
     * @return \Meeteeor\Sdk\Model\LineItemReduction[]
     */
     ...
     * Sets reductions
     *
     * @param \Meeteeor\Sdk\Model\LineItemReduction[] $reductions 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Meeteeor\Sdk\Model\RefundState
     */
     ...
     * Sets state
     *
     * @param \Meeteeor\Sdk\Model\RefundState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \Meeteeor\Sdk\Model\Tax[] $taxes 
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \Meeteeor\Sdk\Model\RefundType
     */
     ...
     * Sets type
     *
     * @param \Meeteeor\Sdk\Model\RefundType $type 
     *
     * @return $this
     */
