...
class Refund implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'amount' => 'float',
        'base_line_items' => '\Planet\Sdk\Model\LineItem[]',
        'completion' => 'int',
        'created_by' => 'int',
        'created_on' => '\DateTime',
        ...
        'reduced_line_items' => '\Planet\Sdk\Model\LineItem[]',
        'reductions' => '\Planet\Sdk\Model\LineItemReduction[]',
        'state' => '\Planet\Sdk\Model\RefundState',
        'succeeded_on' => '\DateTime',
        'taxes' => '\Planet\Sdk\Model\Tax[]',
        'time_zone' => 'string',
        'timeout_on' => '\DateTime',
        'total_applied_fees' => 'float',
        'total_settled_amount' => 'float',
        'transaction' => '\Planet\Sdk\Model\Transaction',
        'type' => '\Planet\Sdk\Model\RefundType',
        'updated_invoice' => 'int',
        'version' => 'int'
    ];
     ...
     *
     * @param \Planet\Sdk\Model\LineItem[] $base_line_items 
     *
     * @return $this
     */
     ...
     *
     * @param \Planet\Sdk\Model\LineItem[] $reduced_line_items 
     *
     * @return $this
     */
     ...
     * Gets reductions
     *
     * @return \Planet\Sdk\Model\LineItemReduction[]
     */
     ...
     * Sets reductions
     *
     * @param \Planet\Sdk\Model\LineItemReduction[] $reductions 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Planet\Sdk\Model\RefundState
     */
     ...
     * Sets state
     *
     * @param \Planet\Sdk\Model\RefundState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \Planet\Sdk\Model\Tax[] $taxes 
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \Planet\Sdk\Model\Transaction $transaction 
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \Planet\Sdk\Model\RefundType
     */
     ...
     * Sets type
     *
     * @param \Planet\Sdk\Model\RefundType $type 
     *
     * @return $this
     */
