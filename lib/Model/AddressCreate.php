...
class AddressCreate implements ModelInterface, ArrayAccess
{
     ...
     * Sets country
     *
     * @param string $country The country is represented with a two-letter code (ISO 3166-1 alpha-2 standard) - for example, CH for Switzerland.
     *
     * @return $this
     */
     ...
     *
     * @param int $legal_organization_form The legal form of the organization.
     *
     * @return $this
     */
