...
class LineItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'attributes' => 'map[string,\Meeteeor\Sdk\Model\LineItemAttribute]',
     ...
     * Gets attributes
     *
     * @return map[string,\Meeteeor\Sdk\Model\LineItemAttribute]
     */
     ...
     * Sets attributes
     *
     * @param map[string,\Meeteeor\Sdk\Model\LineItemAttribute] $attributes 
     *
     * @return $this
     */
