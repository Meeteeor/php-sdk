...
class LineItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'attributes' => 'map[string,\Planet\Sdk\Model\LineItemAttribute]',
     ...
     * Gets attributes
     *
     * @return map[string,\Planet\Sdk\Model\LineItemAttribute]
     */
     ...
     * Sets attributes
     *
     * @param map[string,\Planet\Sdk\Model\LineItemAttribute] $attributes 
     *
     * @return $this
     */
