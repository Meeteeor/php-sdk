...
class TransactionCompletion extends TransactionAwareEntity 
{
    ...
    protected static $swaggerTypes = [
        ...
        'line_item_version' => '\Planet\Sdk\Model\TransactionLineItemVersion',
        'line_items' => '\Planet\Sdk\Model\LineItem[]',
        'mode' => '\Planet\Sdk\Model\TransactionCompletionMode',
        'next_update_on' => '\DateTime',
        'payment_information' => 'string',
        'planned_purge_date' => '\DateTime',
        'processing_on' => '\DateTime',
        'processor_reference' => 'string',
        'remaining_line_items' => '\Planet\Sdk\Model\LineItem[]',
        'space_view_id' => 'int',
        'state' => '\Planet\Sdk\Model\TransactionCompletionState',
     ...
     *
     * @param \Planet\Sdk\Model\LineItem[] $base_line_items The base line items on which the completion is applied on.
     *
     * @return $this
     */
     ...
     *
     * @param \Planet\Sdk\Model\TransactionLineItemVersion $line_item_version 
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \Planet\Sdk\Model\LineItem[] $line_items The line items which are captured.
     *
     * @return $this
     */
     ...
     * Gets mode
     *
     * @return \Planet\Sdk\Model\TransactionCompletionMode
     */
     ...
     * Sets mode
     *
     * @param \Planet\Sdk\Model\TransactionCompletionMode $mode 
     *
     * @return $this
     */
     ...
     *
     * @param \Planet\Sdk\Model\LineItem[] $remaining_line_items 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Planet\Sdk\Model\TransactionCompletionState
     */
     ...
     * Sets state
     *
     * @param \Planet\Sdk\Model\TransactionCompletionState $state The object's current state.
     *
     * @return $this
     */
