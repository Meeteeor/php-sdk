...
class PaymentTerminalLocation implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'state' => '\Meeteeor\Sdk\Model\PaymentTerminalLocationState',
        'version' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \Meeteeor\Sdk\Model\PaymentTerminalLocationState
     */
     ...
     * Sets state
     *
     * @param \Meeteeor\Sdk\Model\PaymentTerminalLocationState $state The object's current state.
     *
     * @return $this
     */
