...
class ClientError implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'string',
        'message' => 'string',
        'type' => '\Meeteeor\Sdk\Model\ClientErrorType'
    ];
     ...
     * Gets type
     *
     * @return \Meeteeor\Sdk\Model\ClientErrorType
     */
     ...
     * Sets type
     *
     * @param \Meeteeor\Sdk\Model\ClientErrorType $type The type of the client error.
     *
     * @return $this
     */
