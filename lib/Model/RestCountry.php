...
class RestCountry implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'address_format' => '\Planet\Sdk\Model\RestAddressFormat',
        'name' => 'string',
        'numeric_code' => 'string',
        'state_codes' => 'string[]'
    ];
     ...
     * Gets address_format
     *
     * @return \Planet\Sdk\Model\RestAddressFormat
     */
     ...
     * Sets address_format
     *
     * @param \Planet\Sdk\Model\RestAddressFormat $address_format Specifies the country's way of formatting addresses.
     *
     * @return $this
     */
