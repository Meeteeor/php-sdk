...
namespace Meeteeor\Sdk\Model;

use \ArrayAccess;
use \Meeteeor\Sdk\ObjectSerializer;
...
class Transaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'authorization_environment' => '\Meeteeor\Sdk\Model\ChargeAttemptEnvironment',
        'authorization_sales_channel' => 'int',
        'authorization_timeout_on' => '\DateTime',
        'authorized_on' => '\DateTime',
        'auto_confirmation_enabled' => 'bool',
        'billing_address' => '\Meeteeor\Sdk\Model\Address',
        'charge_retry_enabled' => 'bool',
        'completed_amount' => 'float',
        'completed_on' => '\DateTime',
        'completion_behavior' => '\Meeteeor\Sdk\Model\TransactionCompletionBehavior',
        ...
        'customer_id' => 'string',
        'customers_presence' => '\Meeteeor\Sdk\Model\CustomersPresence',
        'delivery_decision_made_on' => '\DateTime',
        'device_session_identifier' => 'string',
        'emails_disabled' => 'bool',
        'end_of_life' => '\DateTime',
        'environment' => '\Meeteeor\Sdk\Model\Environment',
        'environment_selection_strategy' => '\Meeteeor\Sdk\Model\TransactionEnvironmentSelectionStrategy',
        'failed_on' => '\DateTime',
        'failed_url' => 'string',
        'failure_reason' => '\Meeteeor\Sdk\Model\FailureReason',
        'group' => '\Meeteeor\Sdk\Model\TransactionGroup',
        'id' => 'int',
        ...
        'java_enabled' => 'bool',
        'language' => 'string',
        'line_items' => '\Meeteeor\Sdk\Model\LineItem[]',
        'linked_space_id' => 'int',
        'merchant_reference' => 'string',
        'meta_data' => 'map[string,string]',
        'parent' => 'int',
        'payment_connector_configuration' => '\Meeteeor\Sdk\Model\PaymentConnectorConfiguration',
        ...
        'screen_width' => 'string',
        'shipping_address' => '\Meeteeor\Sdk\Model\Address',
        'shipping_method' => 'string',
        'space_view_id' => 'int',
        'state' => '\Meeteeor\Sdk\Model\TransactionState',
        'success_url' => 'string',
        'terminal' => '\Meeteeor\Sdk\Model\PaymentTerminal',
        'time_zone' => 'string',
        'token' => '\Meeteeor\Sdk\Model\Token',
        'tokenization_mode' => '\Meeteeor\Sdk\Model\TokenizationMode',
        'total_applied_fees' => 'float',
        'total_settled_amount' => 'float',
        'user_agent_header' => 'string',
        'user_failure_message' => 'string',
        'user_interface_type' => '\Meeteeor\Sdk\Model\TransactionUserInterfaceType',
        'version' => 'int',
     ...
     *
     * @return \Meeteeor\Sdk\Model\ChargeAttemptEnvironment
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\ChargeAttemptEnvironment $authorization_environment The environment in which this transaction was successfully authorized.
     *
     * @return $this
     */
     ...
     *
     * @return \Meeteeor\Sdk\Model\Address
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\Address $billing_address 
     *
     * @return $this
     */
     ...
     *
     * @return \Meeteeor\Sdk\Model\TransactionCompletionBehavior
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\TransactionCompletionBehavior $completion_behavior The completion behavior controls when the transaction is completed.
     *
     * @return $this
     */
     ...
     *
     * @return \Meeteeor\Sdk\Model\CustomersPresence
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\CustomersPresence $customers_presence The customer's presence indicates what kind of authentication method was finally used during authorization of the transaction. If no value is provided, 'Virtually Present' is used by default.
     *
     * @return $this
     */
     ...
     * Gets environment
     *
     * @return \Meeteeor\Sdk\Model\Environment
     */
     ...
     * Sets environment
     *
     * @param \Meeteeor\Sdk\Model\Environment $environment 
     *
     * @return $this
     */
     ...
     *
     * @return \Meeteeor\Sdk\Model\TransactionEnvironmentSelectionStrategy
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\TransactionEnvironmentSelectionStrategy $environment_selection_strategy The environment selection strategy determines how the environment (test or production) for processing the transaction is selected.
     *
     * @return $this
     */
     ...
     * Gets failure_reason
     *
     * @return \Meeteeor\Sdk\Model\FailureReason
     */
     ...
     * Sets failure_reason
     *
     * @param \Meeteeor\Sdk\Model\FailureReason $failure_reason The failure reason describes why the transaction failed. This is only provided when the transaction is marked as failed.
     *
     * @return $this
     */
     ...
     * Gets group
     *
     * @return \Meeteeor\Sdk\Model\TransactionGroup
     */
     ...
     * Sets group
     *
     * @param \Meeteeor\Sdk\Model\TransactionGroup $group 
     *
     * @return $this
     */
     ...
     * Gets line_items
     *
     * @return \Meeteeor\Sdk\Model\LineItem[]
     */
     ...
     * Sets line_items
     *
     * @param \Meeteeor\Sdk\Model\LineItem[] $line_items 
     *
     * @return $this
     */
     ...
     *
     * @return \Meeteeor\Sdk\Model\PaymentConnectorConfiguration
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\PaymentConnectorConfiguration $payment_connector_configuration 
     *
     * @return $this
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\Address $shipping_address 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Meeteeor\Sdk\Model\TransactionState
     */
     ...
     * Sets state
     *
     * @param \Meeteeor\Sdk\Model\TransactionState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Gets terminal
     *
     * @return \Meeteeor\Sdk\Model\PaymentTerminal
     */
     ...
     * Sets terminal
     *
     * @param \Meeteeor\Sdk\Model\PaymentTerminal $terminal The terminal on which the payment was processed.
     *
     * @return $this
     */
     ...
     * Gets token
     *
     * @return \Meeteeor\Sdk\Model\Token
     */
     ...
     * Sets token
     *
     * @param \Meeteeor\Sdk\Model\Token $token 
     *
     * @return $this
     */
     ...
     *
     * @return \Meeteeor\Sdk\Model\TokenizationMode
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\TokenizationMode $tokenization_mode The tokenization mode controls if and how the tokenization of payment information is applied to the transaction.
     *
     * @return $this
     */
     ...
     *
     * @return \Meeteeor\Sdk\Model\TransactionUserInterfaceType
     */
     ...
     *
     * @param \Meeteeor\Sdk\Model\TransactionUserInterfaceType $user_interface_type The user interface type defines through which user interface the transaction has been processed resp. created.
     *
     * @return $this
     */
