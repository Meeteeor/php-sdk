...
class Transaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'authorization_environment' => '\Planet\Sdk\Model\ChargeAttemptEnvironment',
        'authorization_sales_channel' => 'int',
        'authorization_timeout_on' => '\DateTime',
        'authorized_on' => '\DateTime',
        'auto_confirmation_enabled' => 'bool',
        'billing_address' => '\Planet\Sdk\Model\Address',
        'charge_retry_enabled' => 'bool',
        'completed_amount' => 'float',
        'completed_on' => '\DateTime',
        'completion_behavior' => '\Planet\Sdk\Model\TransactionCompletionBehavior',
        ...
        'customer_id' => 'string',
        'customers_presence' => '\Planet\Sdk\Model\CustomersPresence',
        'delivery_decision_made_on' => '\DateTime',
        'device_session_identifier' => 'string',
        'emails_disabled' => 'bool',
        'end_of_life' => '\DateTime',
        'environment' => '\Planet\Sdk\Model\Environment',
        'environment_selection_strategy' => '\Planet\Sdk\Model\TransactionEnvironmentSelectionStrategy',
        'failed_on' => '\DateTime',
        'failed_url' => 'string',
        'failure_reason' => '\Planet\Sdk\Model\FailureReason',
        'group' => '\Planet\Sdk\Model\TransactionGroup',
        'id' => 'int',
        ...
        'java_enabled' => 'bool',
        'language' => 'string',
        'line_items' => '\Planet\Sdk\Model\LineItem[]',
        'linked_space_id' => 'int',
        'merchant_reference' => 'string',
        'meta_data' => 'map[string,string]',
        'parent' => 'int',
        'payment_connector_configuration' => '\Planet\Sdk\Model\PaymentConnectorConfiguration',
        ...
        'screen_width' => 'string',
        'shipping_address' => '\Planet\Sdk\Model\Address',
        'shipping_method' => 'string',
        'space_view_id' => 'int',
        'state' => '\Planet\Sdk\Model\TransactionState',
        'success_url' => 'string',
        'terminal' => '\Planet\Sdk\Model\PaymentTerminal',
        'time_zone' => 'string',
        'token' => '\Planet\Sdk\Model\Token',
        'tokenization_mode' => '\Planet\Sdk\Model\TokenizationMode',
        'total_applied_fees' => 'float',
        'total_settled_amount' => 'float',
        'user_agent_header' => 'string',
        'user_failure_message' => 'string',
        'user_interface_type' => '\Planet\Sdk\Model\TransactionUserInterfaceType',
        'version' => 'int',
     ...
     *
     * @return \Planet\Sdk\Model\ChargeAttemptEnvironment
     */
     ...
     *
     * @param \Planet\Sdk\Model\ChargeAttemptEnvironment $authorization_environment The environment in which this transaction was successfully authorized.
     *
     * @return $this
     */
     ...
     *
     * @return \Planet\Sdk\Model\Address
     */
     ...
     *
     * @param \Planet\Sdk\Model\Address $billing_address 
     *
     * @return $this
     */
     ...
     *
     * @return \Planet\Sdk\Model\TransactionCompletionBehavior
     */
     ...
     *
     * @param \Planet\Sdk\Model\TransactionCompletionBehavior $completion_behavior The completion behavior controls when the transaction is completed.
     *
     * @return $this
     */
     ...
     *
     * @return \Planet\Sdk\Model\CustomersPresence
     */
     ...
     *
     * @param \Planet\Sdk\Model\CustomersPresence $customers_presence The customer's presence indicates what kind of authentication method was finally used during authorization of the transaction. If no value is provided, 'Virtually Present' is used by default.
     *
     * @return $this
     */
     ...
     * Gets environment
     *
     * @return \Planet\Sdk\Model\Environment
     */
     ...
     * Sets environment
     *
     * @param \Planet\Sdk\Model\Environment $environment 
     *
     * @return $this
     */
     ...
     *
     * @return \Planet\Sdk\Model\TransactionEnvironmentSelectionStrategy
     */
     ...
     *
     * @param \Planet\Sdk\Model\TransactionEnvironmentSelectionStrategy $environment_selection_strategy The environment selection strategy determines how the environment (test or production) for processing the transaction is selected.
     *
     * @return $this
     */
     ...
     * Gets failure_reason
     *
     * @return \Planet\Sdk\Model\FailureReason
     */
     ...
     * Sets failure_reason
     *
     * @param \Planet\Sdk\Model\FailureReason $failure_reason The failure reason describes why the transaction failed. This is only provided when the transaction is marked as failed.
     *
     * @return $this
     */
     ...
     * Gets group
     *
     * @return \Planet\Sdk\Model\TransactionGroup
     */
     ...
     * Sets group
     *
     * @param \Planet\Sdk\Model\TransactionGroup $group 
     *
     * @return $this
     */
     ...
     * Gets line_items
     *
     * @return \Planet\Sdk\Model\LineItem[]
     */
     ...
     * Sets line_items
     *
     * @param \Planet\Sdk\Model\LineItem[] $line_items 
     *
     * @return $this
     */
     ...
     *
     * @return \Planet\Sdk\Model\PaymentConnectorConfiguration
     */
     ...
     *
     * @param \Planet\Sdk\Model\PaymentConnectorConfiguration $payment_connector_configuration 
     *
     * @return $this
     */
     ...
     *
     * @param \Planet\Sdk\Model\Address $shipping_address 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Planet\Sdk\Model\TransactionState
     */
     ...
     * Sets state
     *
     * @param \Planet\Sdk\Model\TransactionState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Gets terminal
     *
     * @return \Planet\Sdk\Model\PaymentTerminal
     */
     ...
     * Sets terminal
     *
     * @param \Planet\Sdk\Model\PaymentTerminal $terminal The terminal on which the payment was processed.
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param \Planet\Sdk\Model\Token $token 
     *
     * @return $this
     */
     ...
     *
     * @return \Planet\Sdk\Model\TokenizationMode
     */
     ...
     *
     * @param \Planet\Sdk\Model\TokenizationMode $tokenization_mode The tokenization mode controls if and how the tokenization of payment information is applied to the transaction.
     *
     * @return $this
     */
     ...
     *
     * @return \Planet\Sdk\Model\TransactionUserInterfaceType
     */
     ...
     *
     * @param \Planet\Sdk\Model\TransactionUserInterfaceType $user_interface_type The user interface type defines through which user interface the transaction has been processed resp. created.
     *
     * @return $this
     */
