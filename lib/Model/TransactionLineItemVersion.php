...
class TransactionLineItemVersion extends TransactionAwareEntity 
{
    ...
    protected static $swaggerTypes = [
        ...
        'space_view_id' => 'int',
        'state' => '\Planet\Sdk\Model\TransactionLineItemVersionState',
     ...
     * Gets state
     *
     * @return \Planet\Sdk\Model\TransactionLineItemVersionState
     */
     ...
     * Sets state
     *
     * @param \Planet\Sdk\Model\TransactionLineItemVersionState $state The object's current state.
     *
     * @return $this
     */
