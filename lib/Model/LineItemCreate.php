...
class LineItemCreate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'attributes' => 'map[string,\Planet\Sdk\Model\LineItemAttributeCreate]',
        'discount_including_tax' => 'float',
        'name' => 'string',
        'quantity' => 'float',
        'shipping_required' => 'bool',
        'sku' => 'string',
        'taxes' => '\Planet\Sdk\Model\TaxCreate[]',
        'type' => '\Planet\Sdk\Model\LineItemType',
        'unique_id' => 'string'
    ];
     ...
     * Gets attributes
     *
     * @return map[string,\Planet\Sdk\Model\LineItemAttributeCreate]
     */
     ...
     * Sets attributes
     *
     * @param map[string,\Planet\Sdk\Model\LineItemAttributeCreate] $attributes 
     *
     * @return $this
     */
     ...
     * Gets taxes
     *
     * @return \Planet\Sdk\Model\TaxCreate[]
     */
     ...
     * Sets taxes
     *
     * @param \Planet\Sdk\Model\TaxCreate[] $taxes 
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \Planet\Sdk\Model\LineItemType
     */
     ...
     * Sets type
     *
     * @param \Planet\Sdk\Model\LineItemType $type 
     *
     * @return $this
     */
