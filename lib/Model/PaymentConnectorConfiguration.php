...
class PaymentConnectorConfiguration implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'conditions' => 'int[]',
        'connector' => 'int',
        'enabled_sales_channels' => '\Planet\Sdk\Model\SalesChannel[]',
        'enabled_space_views' => 'int[]',
        'id' => 'int',
        'linked_space_id' => 'int',
        'name' => 'string',
        'payment_method_configuration' => '\Planet\Sdk\Model\PaymentMethodConfiguration',
        'planned_purge_date' => '\DateTime',
        'priority' => 'int',
        'processor_configuration' => '\Planet\Sdk\Model\PaymentProcessorConfiguration',
     ...
     *
     * @return \Planet\Sdk\Model\SalesChannel[]
     */
     ...
     *
     * @param \Planet\Sdk\Model\SalesChannel[] $enabled_sales_channels Defines the sales channels the connector configuration is enabled for. In case the set is empty, the connector configuration is enabled for all sales channels.
     *
     * @return $this
     */
     ...
     *
     * @param \Planet\Sdk\Model\PaymentMethodConfiguration $payment_method_configuration 
     *
     * @return $this
     */
     ...
     *
     * @param \Planet\Sdk\Model\PaymentProcessorConfiguration $processor_configuration 
     *
     * @return $this
     */
