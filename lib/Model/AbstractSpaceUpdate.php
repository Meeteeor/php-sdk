...
class AbstractSpaceUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'postal_address' => '\Planet\Sdk\Model\SpaceAddressCreate',
     ...
     * Gets postal_address
     *
     * @return \Planet\Sdk\Model\SpaceAddressCreate
     */
     ...
     * Sets postal_address
     *
     * @param \Planet\Sdk\Model\SpaceAddressCreate $postal_address The address that is used in communication with clients for example in emails, documents, etc.
     *
     * @return $this
     */
