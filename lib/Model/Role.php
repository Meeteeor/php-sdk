...
class Role implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'permissions' => '\Planet\Sdk\Model\Permission[]',
        'planned_purge_date' => '\DateTime',
        'state' => '\Planet\Sdk\Model\RoleState',
     ...
     * Sets account
     *
     * @param \Planet\Sdk\Model\Account $account The account the role belongs to. The role can only be assigned within this account.
     *
     * @return $this
     */
     ...
     * Sets permissions
     *
     * @param \Planet\Sdk\Model\Permission[] $permissions The permissions granted to users with this role.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Planet\Sdk\Model\RoleState
     */
     ...
     * Sets state
     *
     * @param \Planet\Sdk\Model\RoleState $state The object's current state.
     *
     * @return $this
     */
