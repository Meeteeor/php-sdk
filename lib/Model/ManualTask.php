...
class ManualTask implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'state' => '\Meeteeor\Sdk\Model\ManualTaskState',
        'type' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \Meeteeor\Sdk\Model\ManualTaskState
     */
     ...
     * Sets state
     *
     * @param \Meeteeor\Sdk\Model\ManualTaskState $state The object's current state.
     *
     * @return $this
     */
