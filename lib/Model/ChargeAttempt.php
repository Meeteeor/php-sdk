...
class ChargeAttempt extends TransactionAwareEntity 
{
    ...
    protected static $swaggerTypes = [
        'charge' => '\Planet\Sdk\Model\Charge',
        'completion_behavior' => '\Planet\Sdk\Model\TransactionCompletionBehavior',
        'connector_configuration' => '\Planet\Sdk\Model\PaymentConnectorConfiguration',
        'created_on' => '\DateTime',
        'customers_presence' => '\Planet\Sdk\Model\CustomersPresence',
        'environment' => '\Planet\Sdk\Model\ChargeAttemptEnvironment',
        'failed_on' => '\DateTime',
        'failure_reason' => '\Planet\Sdk\Model\FailureReason',
        'initializing_token_version' => 'bool',
        'invocation' => '\Planet\Sdk\Model\ConnectorInvocation',
        'labels' => '\Planet\Sdk\Model\Label[]',
        'language' => 'string',
        ...
        'sales_channel' => 'int',
        'space_view_id' => 'int',
        'state' => '\Planet\Sdk\Model\ChargeAttemptState',
        'succeeded_on' => '\DateTime',
        'terminal' => '\Planet\Sdk\Model\PaymentTerminal',
        'time_zone' => 'string',
        'timeout_on' => '\DateTime',
        'token_version' => '\Planet\Sdk\Model\TokenVersion',
        'user_failure_message' => 'string',
        'version' => 'int',
        'wallet_type' => '\Planet\Sdk\Model\WalletType'
    ];
     ...
     * Gets charge
     *
     * @return \Planet\Sdk\Model\Charge
     */
     ...
     * Sets charge
     *
     * @param \Planet\Sdk\Model\Charge $charge 
     *
     * @return $this
     */
     ...
     *
     * @param \Planet\Sdk\Model\TransactionCompletionBehavior $completion_behavior 
     *
     * @return $this
     */
     ...
     *
     * @param \Planet\Sdk\Model\PaymentConnectorConfiguration $connector_configuration 
     *
     * @return $this
     */
     ...
     *
     * @param \Planet\Sdk\Model\CustomersPresence $customers_presence The customers presence indicates which kind of customer interaction was used during the charge attempt.
     *
     * @return $this
     */
     ...
     * Sets environment
     *
     * @param \Planet\Sdk\Model\ChargeAttemptEnvironment $environment 
     *
     * @return $this
     */
     ...
     * Sets failure_reason
     *
     * @param \Planet\Sdk\Model\FailureReason $failure_reason 
     *
     * @return $this
     */
     ...
     * Gets invocation
     *
     * @return \Planet\Sdk\Model\ConnectorInvocation
     */
     ...
     * Sets invocation
     *
     * @param \Planet\Sdk\Model\ConnectorInvocation $invocation 
     *
     * @return $this
     */
     ...
     * Sets labels
     *
     * @param \Planet\Sdk\Model\Label[] $labels 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Planet\Sdk\Model\ChargeAttemptState
     */
     ...
     * Sets state
     *
     * @param \Planet\Sdk\Model\ChargeAttemptState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Sets terminal
     *
     * @param \Planet\Sdk\Model\PaymentTerminal $terminal 
     *
     * @return $this
     */
     ...
     * Sets token_version
     *
     * @param \Planet\Sdk\Model\TokenVersion $token_version 
     *
     * @return $this
     */
     ...
     * Gets wallet_type
     *
     * @return \Planet\Sdk\Model\WalletType
     */
     ...
     * Sets wallet_type
     *
     * @param \Planet\Sdk\Model\WalletType $wallet_type 
     *
     * @return $this
     */
