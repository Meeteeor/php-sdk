...
class ConditionTypeService {
	 ...
	 * @return \Meeteeor\Sdk\Model\ConditionType[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\ConditionType[]',
				'/condition-type/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\ConditionType[]', $response->getHeaders()));
