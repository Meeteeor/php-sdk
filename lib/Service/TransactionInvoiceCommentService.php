...
class TransactionInvoiceCommentService {
	 ...
	 * @return \Meeteeor\Sdk\Model\TransactionInvoiceComment[]
	 */
	...
	public function allWithHttpInfo($space_id, $invoice_id) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\TransactionInvoiceComment[]',
				'/transaction-invoice-comment/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\TransactionInvoiceComment[]', $response->getHeaders()));
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Meeteeor\Sdk\Model\TransactionInvoiceCommentCreate $entity  (required)
	 * @throws \Meeteeor\Sdk\ApiException
	 * @throws \Meeteeor\Sdk\VersioningException
	 * @throws \Meeteeor\Sdk\Http\ConnectionException
	 * @return \Meeteeor\Sdk\Model\TransactionInvoiceComment
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Meeteeor\Sdk\Model\TransactionInvoiceCommentActive $entity  (required)
	 * @throws \Meeteeor\Sdk\ApiException
	 * @throws \Meeteeor\Sdk\VersioningException
	 * @throws \Meeteeor\Sdk\Http\ConnectionException
	 * @return \Meeteeor\Sdk\Model\TransactionInvoiceComment
