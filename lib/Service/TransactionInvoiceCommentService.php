...
class TransactionInvoiceCommentService {
	 ...
	 * @return \Planet\Sdk\Model\TransactionInvoiceComment[]
	 */
	...
	public function allWithHttpInfo($space_id, $invoice_id) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Planet\Sdk\Model\TransactionInvoiceComment[]',
				'/transaction-invoice-comment/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Planet\Sdk\Model\TransactionInvoiceComment[]', $response->getHeaders()));
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Planet\Sdk\Model\TransactionInvoiceCommentCreate $entity  (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\TransactionInvoiceComment
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Planet\Sdk\Model\TransactionInvoiceCommentActive $entity  (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\TransactionInvoiceComment
