...
class TransactionLineItemVersionService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/transaction-line-item-version/count';
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Planet\Sdk\Model\TransactionLineItemVersionCreate $line_item_version The line item version object which should be created. (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	...
	public function createWithHttpInfo($space_id, $line_item_version) {
		...
		if (is_null($line_item_version)) {
			throw new \InvalidArgumentException('Missing the required parameter $line_item_version when calling create');
		}
		// header params
		$headerParams = [];
		$headerAccept = $this->apiClient->selectHeaderAccept(['application/json;charset=utf-8']);
		...
		// path params
		$resourcePath = '/transaction-line-item-version/create';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		// body params
		$tempBody = null;
		if (isset($line_item_version)) {
			$tempBody = $line_item_version;
		}
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/transaction-line-item-version/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Planet\Sdk\Model\EntityQuery $query The query restricts line item versions which are returned by the search. (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\TransactionLineItemVersion[]
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/transaction-line-item-version/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
