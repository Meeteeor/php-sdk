...
class StaticValueService {
	 ...
	 * @return \Planet\Sdk\Model\StaticValue[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Planet\Sdk\Model\StaticValue[]',
				'/static-value-service/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Planet\Sdk\Model\StaticValue[]', $response->getHeaders()));
