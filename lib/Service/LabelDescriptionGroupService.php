...
class LabelDescriptionGroupService {
	 ...
	 * @return \Meeteeor\Sdk\Model\LabelDescriptorGroup[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\LabelDescriptorGroup[]',
				'/label-description-group-service/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\LabelDescriptorGroup[]', $response->getHeaders()));
