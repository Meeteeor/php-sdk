...
class TransactionCommentService {
	 ...
	 * @return \Planet\Sdk\Model\TransactionComment[]
	 */
	...
	public function allWithHttpInfo($space_id, $transaction_id) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Planet\Sdk\Model\TransactionComment[]',
				'/transaction-comment/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Planet\Sdk\Model\TransactionComment[]', $response->getHeaders()));
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Planet\Sdk\Model\TransactionCommentCreate $entity  (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\TransactionComment
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Planet\Sdk\Model\TransactionCommentActive $entity  (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\TransactionComment
