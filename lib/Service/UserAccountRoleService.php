...
class UserAccountRoleService {
	 ...
	 * @return \Planet\Sdk\Model\UserAccountRole
	 */
	...
	public function addRoleWithHttpInfo($user_id, $account_id, $role_id, $applies_on_subaccount = null) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Planet\Sdk\Model\UserAccountRole',
				'/user-account-role/addRole'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Planet\Sdk\Model\UserAccountRole', $response->getHeaders()));
