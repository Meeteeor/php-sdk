...
class HumanUserService {
	 ...
	 * Create
	 *
	 * @param \Planet\Sdk\Model\HumanUserCreate $entity The human user object with the properties which should be created. (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\HumanUser
	 */
	...
	public function createWithHttpInfo($entity) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Planet\Sdk\Model\HumanUser',
				'/human-user/create'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Planet\Sdk\Model\HumanUser', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 * Search
	 *
	 * @param \Planet\Sdk\Model\EntityQuery $query The query restricts the human users which are returned by the search. (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\HumanUser[]
	 ...
	 * Update
	 *
	 * @param \Planet\Sdk\Model\HumanUserUpdate $entity The object with all the properties which should be updated. The id and the version are required properties. (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\HumanUser
