...
class HumanUserService {
	 ...
	 * Create
	 *
	 * @param \Meeteeor\Sdk\Model\HumanUserCreate $entity The human user object with the properties which should be created. (required)
	 * @throws \Meeteeor\Sdk\ApiException
	 * @throws \Meeteeor\Sdk\VersioningException
	 * @throws \Meeteeor\Sdk\Http\ConnectionException
	 * @return \Meeteeor\Sdk\Model\HumanUser
	 */
	...
	public function createWithHttpInfo($entity) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\HumanUser',
				'/human-user/create'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\HumanUser', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 * Search
	 *
	 * @param \Meeteeor\Sdk\Model\EntityQuery $query The query restricts the human users which are returned by the search. (required)
	 * @throws \Meeteeor\Sdk\ApiException
	 * @throws \Meeteeor\Sdk\VersioningException
	 * @throws \Meeteeor\Sdk\Http\ConnectionException
	 * @return \Meeteeor\Sdk\Model\HumanUser[]
	 ...
	 * Update
	 *
	 * @param \Meeteeor\Sdk\Model\HumanUserUpdate $entity The object with all the properties which should be updated. The id and the version are required properties. (required)
	 * @throws \Meeteeor\Sdk\ApiException
	 * @throws \Meeteeor\Sdk\VersioningException
	 * @throws \Meeteeor\Sdk\Http\ConnectionException
	 * @return \Meeteeor\Sdk\Model\HumanUser
