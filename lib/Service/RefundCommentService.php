...
class RefundCommentService {
	 ...
	 * @return \Planet\Sdk\Model\RefundComment[]
	 */
	...
	public function allWithHttpInfo($space_id, $refund_id) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Planet\Sdk\Model\RefundComment[]',
				'/refund-comment/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Planet\Sdk\Model\RefundComment[]', $response->getHeaders()));
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Planet\Sdk\Model\RefundCommentCreate $entity  (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\RefundComment
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Planet\Sdk\Model\RefundCommentActive $entity  (required)
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\VersioningException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @return \Planet\Sdk\Model\RefundComment
