...
class CountryStateService {
	 ...
	 * @return \Planet\Sdk\Model\RestCountryState[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Planet\Sdk\Model\RestCountryState[]',
				'/country-state/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Planet\Sdk\Model\RestCountryState[]', $response->getHeaders()));
