...
class CountryStateService {
	 ...
	 * @return \Meeteeor\Sdk\Model\RestCountryState[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\RestCountryState[]',
				'/country-state/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\RestCountryState[]', $response->getHeaders()));
