...
class LegalOrganizationFormService {
	 ...
	 * @return \Planet\Sdk\Model\LegalOrganizationForm[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Planet\Sdk\Model\LegalOrganizationForm[]',
				'/legal-organization-form/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Planet\Sdk\Model\LegalOrganizationForm[]', $response->getHeaders()));
