...
class CountryService {
	 ...
	 * @return \Meeteeor\Sdk\Model\RestCountry[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\RestCountry[]',
				'/country/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\RestCountry[]', $response->getHeaders()));
