...
class PaymentProcessorService {
	 ...
	 * @return \Meeteeor\Sdk\Model\PaymentProcessor[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\PaymentProcessor[]',
				'/payment-processor/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\PaymentProcessor[]', $response->getHeaders()));
