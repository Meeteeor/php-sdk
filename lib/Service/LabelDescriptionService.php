...
class LabelDescriptionService {
	 ...
	 * @return \Meeteeor\Sdk\Model\LabelDescriptor[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\LabelDescriptor[]',
				'/label-description-service/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\LabelDescriptor[]', $response->getHeaders()));
