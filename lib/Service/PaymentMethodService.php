...
class PaymentMethodService {
	 ...
	 * @return \Meeteeor\Sdk\Model\PaymentMethod[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\PaymentMethod[]',
				'/payment-method/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\PaymentMethod[]', $response->getHeaders()));
