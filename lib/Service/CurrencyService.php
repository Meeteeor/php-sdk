...
class CurrencyService {
	 ...
	 * @return \Meeteeor\Sdk\Model\RestCurrency[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\RestCurrency[]',
				'/currency/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\RestCurrency[]', $response->getHeaders()));
