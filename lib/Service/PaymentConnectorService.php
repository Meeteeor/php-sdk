...
class PaymentConnectorService {
	 ...
	 * @return \Meeteeor\Sdk\Model\PaymentConnector[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\PaymentConnector[]',
				'/payment-connector/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\PaymentConnector[]', $response->getHeaders()));
