...
class AccountService {
	 ...
	 * Create
	 *
	 * @param \Meeteeor\Sdk\Model\AccountCreate $entity The account object with the properties which should be created. (required)
	 * @throws \Meeteeor\Sdk\ApiException
	 * @throws \Meeteeor\Sdk\VersioningException
	 * @throws \Meeteeor\Sdk\Http\ConnectionException
	 * @return \Meeteeor\Sdk\Model\Account
	 */
	...
	public function createWithHttpInfo($entity) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\Account',
				'/account/create'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\Account', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 * Search
	 *
	 * @param \Meeteeor\Sdk\Model\EntityQuery $query The query restricts the accounts which are returned by the search. (required)
	 * @throws \Meeteeor\Sdk\ApiException
	 * @throws \Meeteeor\Sdk\VersioningException
	 * @throws \Meeteeor\Sdk\Http\ConnectionException
	 * @return \Meeteeor\Sdk\Model\Account[]
	 ...
	 * Update
	 *
	 * @param \Meeteeor\Sdk\Model\AccountUpdate $entity The account object with all the properties which should be updated. The id and the version are required properties. (required)
	 * @throws \Meeteeor\Sdk\ApiException
	 * @throws \Meeteeor\Sdk\VersioningException
	 * @throws \Meeteeor\Sdk\Http\ConnectionException
	 * @return \Meeteeor\Sdk\Model\Account
