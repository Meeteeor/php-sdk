...
class UserSpaceRoleService {
	 ...
	 * @return \Meeteeor\Sdk\Model\UserSpaceRole
	 */
	...
	public function addRoleWithHttpInfo($user_id, $space_id, $role_id) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Meeteeor\Sdk\Model\UserSpaceRole',
				'/user-space-role/addRole'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Meeteeor\Sdk\Model\UserSpaceRole', $response->getHeaders()));
