...
namespace Planet\Sdk;

use Planet\Sdk\ApiException;
use Planet\Sdk\VersioningException;
use Planet\Sdk\Http\HttpRequest;
use Planet\Sdk\Http\HttpClientFactory;
...
final class ApiClient {
	 ...
	 * @var string
	 */
	private $userAgent = 'PHP-Client/3.2.1/php';
	 ...
	 *
	 * @return string
	 * @see \Planet\Sdk\Http\HttpClientFactory
	 */
	 ...
	 *
	 * @return \Planet\Sdk\ApiResponse
	 * @throws \Planet\Sdk\ApiException
	 * @throws \Planet\Sdk\Http\ConnectionException
	 * @throws \Planet\Sdk\VersioningException
	 */
    ...
    /**
     * @return \Planet\Sdk\Service\AccountService
     */
    public function getAccountService() {
        if(is_null($this->accountService)){
            $this->accountService = new \Planet\Sdk\Service\AccountService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\ApplicationUserService
     */
    public function getApplicationUserService() {
        if(is_null($this->applicationUserService)){
            $this->applicationUserService = new \Planet\Sdk\Service\ApplicationUserService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\ChargeAttemptService
     */
    public function getChargeAttemptService() {
        if(is_null($this->chargeAttemptService)){
            $this->chargeAttemptService = new \Planet\Sdk\Service\ChargeAttemptService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\ChargeFlowLevelPaymentLinkService
     */
    public function getChargeFlowLevelPaymentLinkService() {
        if(is_null($this->chargeFlowLevelPaymentLinkService)){
            $this->chargeFlowLevelPaymentLinkService = new \Planet\Sdk\Service\ChargeFlowLevelPaymentLinkService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\ChargeFlowLevelService
     */
    public function getChargeFlowLevelService() {
        if(is_null($this->chargeFlowLevelService)){
            $this->chargeFlowLevelService = new \Planet\Sdk\Service\ChargeFlowLevelService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\ChargeFlowService
     */
    public function getChargeFlowService() {
        if(is_null($this->chargeFlowService)){
            $this->chargeFlowService = new \Planet\Sdk\Service\ChargeFlowService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\ConditionTypeService
     */
    public function getConditionTypeService() {
        if(is_null($this->conditionTypeService)){
            $this->conditionTypeService = new \Planet\Sdk\Service\ConditionTypeService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\CountryService
     */
    public function getCountryService() {
        if(is_null($this->countryService)){
            $this->countryService = new \Planet\Sdk\Service\CountryService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\CountryStateService
     */
    public function getCountryStateService() {
        if(is_null($this->countryStateService)){
            $this->countryStateService = new \Planet\Sdk\Service\CountryStateService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\CurrencyService
     */
    public function getCurrencyService() {
        if(is_null($this->currencyService)){
            $this->currencyService = new \Planet\Sdk\Service\CurrencyService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\CustomerAddressService
     */
    public function getCustomerAddressService() {
        if(is_null($this->customerAddressService)){
            $this->customerAddressService = new \Planet\Sdk\Service\CustomerAddressService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\CustomerCommentService
     */
    public function getCustomerCommentService() {
        if(is_null($this->customerCommentService)){
            $this->customerCommentService = new \Planet\Sdk\Service\CustomerCommentService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\CustomerService
     */
    public function getCustomerService() {
        if(is_null($this->customerService)){
            $this->customerService = new \Planet\Sdk\Service\CustomerService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\HumanUserService
     */
    public function getHumanUserService() {
        if(is_null($this->humanUserService)){
            $this->humanUserService = new \Planet\Sdk\Service\HumanUserService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\LabelDescriptionGroupService
     */
    public function getLabelDescriptionGroupService() {
        if(is_null($this->labelDescriptionGroupService)){
            $this->labelDescriptionGroupService = new \Planet\Sdk\Service\LabelDescriptionGroupService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\LabelDescriptionService
     */
    public function getLabelDescriptionService() {
        if(is_null($this->labelDescriptionService)){
            $this->labelDescriptionService = new \Planet\Sdk\Service\LabelDescriptionService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\LanguageService
     */
    public function getLanguageService() {
        if(is_null($this->languageService)){
            $this->languageService = new \Planet\Sdk\Service\LanguageService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\LegalOrganizationFormService
     */
    public function getLegalOrganizationFormService() {
        if(is_null($this->legalOrganizationFormService)){
            $this->legalOrganizationFormService = new \Planet\Sdk\Service\LegalOrganizationFormService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\ManualTaskService
     */
    public function getManualTaskService() {
        if(is_null($this->manualTaskService)){
            $this->manualTaskService = new \Planet\Sdk\Service\ManualTaskService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\PaymentConnectorConfigurationService
     */
    public function getPaymentConnectorConfigurationService() {
        if(is_null($this->paymentConnectorConfigurationService)){
            $this->paymentConnectorConfigurationService = new \Planet\Sdk\Service\PaymentConnectorConfigurationService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\PaymentConnectorService
     */
    public function getPaymentConnectorService() {
        if(is_null($this->paymentConnectorService)){
            $this->paymentConnectorService = new \Planet\Sdk\Service\PaymentConnectorService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\PaymentMethodBrandService
     */
    public function getPaymentMethodBrandService() {
        if(is_null($this->paymentMethodBrandService)){
            $this->paymentMethodBrandService = new \Planet\Sdk\Service\PaymentMethodBrandService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\PaymentMethodConfigurationService
     */
    public function getPaymentMethodConfigurationService() {
        if(is_null($this->paymentMethodConfigurationService)){
            $this->paymentMethodConfigurationService = new \Planet\Sdk\Service\PaymentMethodConfigurationService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\PaymentMethodService
     */
    public function getPaymentMethodService() {
        if(is_null($this->paymentMethodService)){
            $this->paymentMethodService = new \Planet\Sdk\Service\PaymentMethodService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\PaymentProcessorConfigurationService
     */
    public function getPaymentProcessorConfigurationService() {
        if(is_null($this->paymentProcessorConfigurationService)){
            $this->paymentProcessorConfigurationService = new \Planet\Sdk\Service\PaymentProcessorConfigurationService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\PaymentProcessorService
     */
    public function getPaymentProcessorService() {
        if(is_null($this->paymentProcessorService)){
            $this->paymentProcessorService = new \Planet\Sdk\Service\PaymentProcessorService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\PermissionService
     */
    public function getPermissionService() {
        if(is_null($this->permissionService)){
            $this->permissionService = new \Planet\Sdk\Service\PermissionService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\RefundCommentService
     */
    public function getRefundCommentService() {
        if(is_null($this->refundCommentService)){
            $this->refundCommentService = new \Planet\Sdk\Service\RefundCommentService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\SpaceService
     */
    public function getSpaceService() {
        if(is_null($this->spaceService)){
            $this->spaceService = new \Planet\Sdk\Service\SpaceService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\StaticValueService
     */
    public function getStaticValueService() {
        if(is_null($this->staticValueService)){
            $this->staticValueService = new \Planet\Sdk\Service\StaticValueService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\TransactionCommentService
     */
    public function getTransactionCommentService() {
        if(is_null($this->transactionCommentService)){
            $this->transactionCommentService = new \Planet\Sdk\Service\TransactionCommentService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\TransactionInvoiceCommentService
     */
    public function getTransactionInvoiceCommentService() {
        if(is_null($this->transactionInvoiceCommentService)){
            $this->transactionInvoiceCommentService = new \Planet\Sdk\Service\TransactionInvoiceCommentService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\TransactionInvoiceService
     */
    public function getTransactionInvoiceService() {
        if(is_null($this->transactionInvoiceService)){
            $this->transactionInvoiceService = new \Planet\Sdk\Service\TransactionInvoiceService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\TransactionLineItemVersionService
     */
    public function getTransactionLineItemVersionService() {
        if(is_null($this->transactionLineItemVersionService)){
            $this->transactionLineItemVersionService = new \Planet\Sdk\Service\TransactionLineItemVersionService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\TransactionService
     */
    public function getTransactionService() {
        if(is_null($this->transactionService)){
            $this->transactionService = new \Planet\Sdk\Service\TransactionService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\UserAccountRoleService
     */
    public function getUserAccountRoleService() {
        if(is_null($this->userAccountRoleService)){
            $this->userAccountRoleService = new \Planet\Sdk\Service\UserAccountRoleService($this);
        }
    ...
    /**
     * @return \Planet\Sdk\Service\UserSpaceRoleService
     */
    public function getUserSpaceRoleService() {
        if(is_null($this->userSpaceRoleService)){
            $this->userSpaceRoleService = new \Planet\Sdk\Service\UserSpaceRoleService($this);
        }
