[![Build Status](https://travis-ci.org/Meeteeor/php-sdk.svg?branch=master)](https://travis-ci.org/Meeteeor/php-sdk)
...
[Meeteeor Web Service API](https://paymentshub.weareplanet.com/doc/api/web-service)
