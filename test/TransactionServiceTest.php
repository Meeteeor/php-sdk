...
namespace Planet\Sdk\Test;

use PHPUnit\Framework\TestCase;
use Planet\Sdk\ApiClient;
use Planet\Sdk\Http\HttpClientFactory;
use Planet\Sdk\Model\AddressCreate;
use Planet\Sdk\Model\CriteriaOperator;
use Planet\Sdk\Model\EntityQuery;
use Planet\Sdk\Model\EntityQueryFilter;
use Planet\Sdk\Model\EntityQueryFilterType;
use Planet\Sdk\Model\LineItemCreate;
use Planet\Sdk\Model\LineItemType;
use Planet\Sdk\Model\PaymentMethodConfiguration;
use Planet\Sdk\Model\TransactionCreate;
use Planet\Sdk\Model\TransactionPending;
...
class TransactionServiceTest extends TestCase
{
    ...
    /**
     * @var Planet\Sdk\ApiClient
     */
    private $apiClient;

    /**
     * @var Planet\Sdk\Model\TransactionCreate
     */
